...
SELECT _exam.id_exam, classrooms.id_classroom, classrooms.classroom
  FROM _exam, exams, classrooms
  WHERE _exam.id_exam = exams.id_exam AND exams.id_classroom = classrooms.id_classroom
  INTO CURSOR ans
